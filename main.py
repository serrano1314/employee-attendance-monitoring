...
class Main:
    ...
    def edit_record(self,page,record_id):
        ...
        self.c.execute(f"SELECT * FROM employees WHERE employee_id = '{record_id}'")
        ...
        Button(edit_record_page,text="SAVE",width=15,command=lambda id=record_id:self.update_query(edit_record_page,id),bg='#AAFE92').grid(row=9,column=table_col,pady=20)
